...
class PipelineSmokeTest(unittest.TestCase):
    def test_pipeline_creates_required_artifacts(self) -> None:
        ...
        self.assertTrue((submission_root / "[Clustering]_Submission_Akhir_BMLP_Your_Name.ipynb").exists())
        self.assertTrue((submission_root / "[Klasifikasi]_Submission_Akhir_BMLP_Your_Name.ipynb").exists())
