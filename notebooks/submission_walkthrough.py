...
joblib.dump(kmeans, MODELS_DIR / "model_clustering.joblib")
...
cleaned_with_target.groupby("Target")[numeric_columns].agg(["mean", "min", "max"])

# %%
X = clustered_df.drop(columns=["Target"])
...
# %%
joblib.dump(decision_tree, MODELS_DIR / "decision_tree_model.h5")

# %%
pd.read_csv(PREPROCESSED_DATASET_PATH).head()
